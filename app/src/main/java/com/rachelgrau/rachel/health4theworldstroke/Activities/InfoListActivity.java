...
public class InfoListActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_INFO_TYPE_SPAN= "infoType";
    ...
    public static final String INFO_TYPE_ABOUT_US_SPAN = "Sobre nosotros";
    public static final String INFO_TYPE_TERMS_SPAN = "Términos y condiciones";
    public static final String INFO_TYPE_PRIVACY_POLICY_SPAN = "Política de privacidad";
    public static final String INFO_TYPE_COPYRIGHT = "Copyright";
    public static final String INFO_TYPE_COPYRIGHT_SPAN = "Copyright";
    ...
    private void setUpToolbar() {
        ...
        myToolbar.setTitle(R.string.info_title);
    ...
    private void setUpListView() {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.info_list_toolbar);
        if(myToolbar.getTitle().equals("Información")) {
            myToolbar.setTitle("");
            content.add(INFO_TYPE_ABOUT_US_SPAN);
            content.add(INFO_TYPE_TERMS_SPAN);
            content.add(INFO_TYPE_PRIVACY_POLICY_SPAN);
        }
        if(myToolbar.getTitle().equals("Info")){
            myToolbar.setTitle("");
